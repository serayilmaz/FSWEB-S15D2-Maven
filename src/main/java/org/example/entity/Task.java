...
public class Task {
    ...
    // EŞİTLİK KURALI: project + description
    @Override
    public boolean equals(Object o) {
        if (this == o) return true;              // aynı obje mi?
        if (!(o instanceof Task)) return false;  // Task değilse false
        Task task = (Task) o;

        // sadece project ve description'a bakıyoruz
